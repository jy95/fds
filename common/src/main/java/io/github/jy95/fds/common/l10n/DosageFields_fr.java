...
public class DosageFields_fr extends ListResourceBundle {
    ...
    static final Object[][] contents = {
            ...
            { "amount.range.withUnit",
                    "{condition, select, 0{{minValue} à {maxValue} {unit}} 1{{maxValue} {unit} maximum} other{au moins {minValue} {unit}}}" },
            { "amount.range.withoutUnit",
                    "{condition, select, 0{{minValue} à {maxValue}} 1{{maxValue} maximum} other{au moins {minValue}}}" },
            ...
            { "fields.frequencyAndFrequencyMax",
                    "{maxFrequency, plural, one{{frequency}-{maxFrequency} fois} other{{frequency}-{maxFrequency} fois}}" },
            ...
            { "fields.boundsPeriod",
                    "{condition, select, 0{du {startDate} au {endDate}} 1{à partir du {startDate}} other{jusqu’au {endDate}} }" },
            { "fields.boundsRange", "pour {0}" },

            // Fields - Count
            { "fields.count", "{0, plural, one{prendre {0} fois} other{prendre {0} fois}}" },
            { "fields.countMax",
                    "{maxCount, plural, one{prendre {minCount} à {maxCount} fois} other{prendre {minCount} à {maxCount} fois}}" },
