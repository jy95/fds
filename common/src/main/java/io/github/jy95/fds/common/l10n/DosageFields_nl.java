...
public class DosageFields_nl extends ListResourceBundle {
    ...
    static final Object[][] contents = {
            ...
            { "amount.range.withUnit",
                    "{condition, select, 0{tussen {minValue} en {maxValue} {unit}} 1{tot {maxValue} {unit}} other{minstens {minValue} {unit}}}" },
            { "amount.range.withoutUnit",
                    "{condition, select, 0{tussen {minValue} en {maxValue}} 1{tot {maxValue}} other{minstens {minValue}}}" },
            ...
            { "fields.frequencyAndFrequencyMax",
                    "{maxFrequency, plural, one{{frequency}-{maxFrequency} keer} other{{frequency}-{maxFrequency} keer}}" },
            ...
            { "fields.boundsPeriod",
                    "{condition, select, 0{van {startDate} tot {endDate}} 1{van {startDate}} other{tot {endDate}} }" },
            { "fields.boundsRange", "gedurende {0}" },

            // Fields - Count
            { "fields.count", "{0, plural, one{{0} keer nemen} other{{0} keer nemen}}" },
            { "fields.countMax",
                    "{maxCount, plural, one{{minCount} tot {maxCount} keer nemen} other{{minCount} tot {maxCount} keer nemen}}" },
