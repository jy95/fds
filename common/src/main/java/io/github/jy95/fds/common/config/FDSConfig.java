...
public class FDSConfig {
     ...
     */
    @Builder.Default private final List<DisplayOrder> displayOrder = DefaultImplementations.DEFAULT_DISPLAY_ORDER;
    // Override separator between each part of "Dosage"
    @Builder.Default private final String displaySeparator = DefaultImplementations.DEFAULT_SEPARATOR;
    /**
