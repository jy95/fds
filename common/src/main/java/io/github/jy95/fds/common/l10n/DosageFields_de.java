...
public class DosageFields_de extends ListResourceBundle {
    ...
    static final Object[][] contents = {
            ...
            { "amount.range.withUnit",
                    "{condition, select, 0{zwischen {minValue} und {maxValue} {unit}} 1{bis {maxValue} {unit}} other{mindestens {minValue} {unit}}}" },
            { "amount.range.withoutUnit",
                    "{condition, select, 0{zwischen {minValue} und {maxValue}} 1{bis {maxValue}} other{mindestens {minValue}}}" },
            ...
            { "fields.frequencyAndFrequencyMax",
                    "{maxFrequency, plural, one{{frequency}-{maxFrequency} Mal} other{{frequency}-{maxFrequency} Mal}}" },
            ...
            { "fields.boundsPeriod",
                    "{condition, select, 0{von {startDate} bis {endDate}} 1{ab {startDate}} other{bis {endDate}} }" },
            { "fields.boundsRange", "für {0}" },

            // Fields - Count
            { "fields.count", "{0, plural, one{{0} Mal nehmen} other{{0} Mal nehmen}}" },
            { "fields.countMax",
                    "{maxCount, plural, one{von {minCount} bis {maxCount} Mal nehmen} other{von {minCount} bis {maxCount} Mal nehmen}}" },
