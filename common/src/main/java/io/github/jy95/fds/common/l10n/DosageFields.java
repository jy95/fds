...
public class DosageFields extends ListResourceBundle {
    ...
    static final Object[][] contents = {
            ...
            { "amount.range.withUnit",
                    "{condition, select, 0{{minValue} to {maxValue} {unit}} 1{up to {maxValue} {unit}} other{at least {minValue} {unit}}}" },
            { "amount.range.withoutUnit",
                    "{condition, select, 0{{minValue} to {maxValue}} 1{up to {maxValue}} other{at least {minValue}}}" },
            ...
            { "fields.frequencyAndFrequencyMax",
                    "{maxFrequency, plural, one{{frequency}-{maxFrequency} time} other{{frequency}-{maxFrequency} times}}" },
            ...
            { "fields.boundsPeriod",
                    "{condition, select, 0{from {startDate} to {endDate}} 1{from {startDate}} other{to {endDate}} }" },
            { "fields.boundsRange", "for {0}" },

            // Fields - Count
            { "fields.count", "{0, plural, one{take {0} time} other{take {0} times}}" },
            { "fields.countMax",
                    "{maxCount, plural, one{take {minCount} to {maxCount} time} other{take {minCount} to {maxCount} times}}" },
