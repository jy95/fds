...
/**
 * A functional interface for extracting a dose and rate component from a given
 * input.
 *
 * @param <A> the type of the input from which the dose and rate will be
 *            extracted
...
public interface DoseAndRateExtractor<A, B> {
     ...
     *
     * @param doseAndRateComponent the input from which the dose and rate will be
     *                             extracted
