...
public final class UnitsOfTimeFormatter {
        ...
        /**
         * Map each code of
         * <a href="https://build.fhir.org/valueset-units-of-time.html">Units of
         * Time</a> to their ICU4J units
         */
         ...
         * @param unit   The <a href=
         *               "https://build.fhir.org/valueset-units-of-time.html">unit
         *               code</a>
        ...
        public static String formatWithoutCount(Locale locale, String unit, Number count) {
                // ICU4j doesn't have a method for extracting only the unit with plural form so
                // a bit of magic here
                return formatter
                                .unit(UNIT_MAPPING.get(unit))
                                .locale(locale)
