...
public interface Translator<D> {
    /**
     * Converts a field into a human-readable string representation
     * asynchronously.
     *
     * @param data the fhir element containing field to be converted
     * @return a {@link java.util.concurrent.CompletableFuture} that will complete
     *         with the human-readable string
     */
    CompletableFuture<String> convert(D data);
