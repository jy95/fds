...
public abstract class AbstractAsNeededTest<C extends FDSConfig, D> extends AbstractTranslatorTest<C, D> {
    ...
    public static String getExpectedText1(Locale locale) {
        if (locale.equals(Locale.ENGLISH)) {
            return "as required";
        } else if (locale.equals(Locale.forLanguageTag("it"))) { return "come richiesto"; } else if (locale.equals(Locale.FRENCH)) {
    ...
    public String getExpectedText2(Locale locale) {
        ...
        } else if (locale.equals(Locale.forLanguageTag("it"))) { return "come richiesto per il dolore alla testa"; } else if (locale.equals(Locale.FRENCH)) {
