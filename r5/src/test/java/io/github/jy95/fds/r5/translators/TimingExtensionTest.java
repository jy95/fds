...
import io.github.jy95.fds.translators.AbstractTimingExtensionTest;
...
public class TimingExtensionTest extends AbstractTimingExtensionTest<FDSConfigR5, Dosage> {
    ...
    protected FDSConfigR5 generateCustomConfig(Locale locale) {
        return FDSConfigR5
                .builder()
                .displayOrder(List.of(DisplayOrder.TIMING_EXTENSION))
                .locale(locale)
