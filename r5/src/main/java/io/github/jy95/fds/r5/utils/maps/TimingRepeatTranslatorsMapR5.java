 ...
 * @author jy95
 */
public class TimingRepeatTranslatorsMapR5 extends AbstractTranslatorsMap<FDSConfigR5, TimingRepeatComponent> {

    /**
     * Constructor for {@code TimingRepeatTranslatorsMapR5}.
     *
     * @param translationService The translation service used for translation.
     */
    public TimingRepeatTranslatorsMapR5(TranslationService<FDSConfigR5> translationService) {
    ...
    protected Map<DisplayOrder, Supplier<Translator<TimingRepeatComponent>>> createTranslatorsSuppliers() {
        ...
        suppliers.put(DisplayOrder.PERIOD_PERIOD_MAX, () -> PeriodPeriodMax.<TimingRepeatComponent, FDSConfigR5>builder()
