...
public class TimingTranslatorsMapR5 extends AbstractTranslatorsMap<FDSConfigR5, Timing> {
    ...
    protected Map<DisplayOrder, Supplier<Translator<Timing>>> createTranslatorsSuppliers() {
        ...
        suppliers.put(DisplayOrder.TIMING_EXTENSION, () -> ExtensionTranslator.<Timing, FDSConfigR5>builder()
                .translationService(translationService)
                .build()
        );
        suppliers.put(DisplayOrder.TIMING_MODIFIER_EXTENSION, () -> ExtensionTranslator.<Timing, FDSConfigR5>builder()
                .translationService(translationService)
