...
import io.github.jy95.fds.translators.AbstractTimingModifierExtensionTest;
...
public class TimingModifierExtensionTest extends AbstractTimingModifierExtensionTest<FDSConfigR4, Dosage> {
    ...
    protected FDSConfigR4 generateCustomConfig(Locale locale) {
        return FDSConfigR4
                .builder()
                .displayOrder(List.of(DisplayOrder.TIMING_MODIFIER_EXTENSION))
                .locale(locale)
